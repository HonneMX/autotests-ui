...
class NavbarComponent(BaseComponent):
    def __init__(self, page: Page):
        ...
        self.app_title_text = page.get_by_test_id('navigation-navbar-app-title-text')
        self.welcome_title = page.get_by_test_id('navigation-navbar-welcome-title-text')

    def check_visible(self, username: str):
        expect(self.app_title_text).to_be_visible()
        expect(self.app_title_text).to_have_text('UI Course')
